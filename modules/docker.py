...
class DockerModule:
    ...
    def __init__(self):
        ...
        self.enabled = getattr(config, "DOCKER_ENABLED", True)

        self.start_time = time.time()

        if self.enabled:

            print("Docker Module gestartet")
    ...
    def get_system_info(self):
        ...
        return {
            ...
            "docker": self.is_running_in_docker(),
    ...
    def health_check(self, modules=None):
        ...
        if modules:
            ...
            for name, module in modules.items():
                ...
                try:
                    ...
                    status["modules"][name] = {"status": "ERROR"}
