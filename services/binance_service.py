...
class BinanceService:
    ...
    def get_candles(
        self, symbol="BTCUSDT", interval=Client.KLINE_INTERVAL_1HOUR, limit=100
    ):
        """
        Historische Kerzen
        """
    ...
    def get_all_balances(self):
        ...
        for item in account["balances"]:
            ...
            if amount > 0:
                ...
                result.append({"asset": item["asset"], "amount": amount})
    ...
    def get_trades(self, symbol="BTCUSDT"):
        """
        Eigene Trades
        """
